...
void Pipe(void* a1, void* a2, void* a3) {
  ...
  for (my_input_2 = read_from_queue(myInputQueue_2);
       my_input_2>0;
  ...
  for (my_input_3 = read_from_queue(myInputQueue_3);
       my_input_3 >= 0;
       my_input_3 = read_from_queue(myInputQueue_3)) {
    if (my_input_3 >= 0) // Is this wrong, Vladimir?
